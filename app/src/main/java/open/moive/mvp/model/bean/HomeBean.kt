...
data class HomeBean(var nextPageUrl: String?,var nextPublishTime: Long,
                    ...
                    var issueList: List<open.moive.mvp.model.bean.HomeBean.IssueListBean>?) {

    data class IssueListBean(var releaseTime: Long,var type: String?,
                             var date: Long,var publishTime: Long,var count: Int,
                             var itemList: List<open.moive.mvp.model.bean.HomeBean.IssueListBean.ItemListBean>?) {

        data class ItemListBean(var type: String?, var data: open.moive.mvp.model.bean.HomeBean.IssueListBean.ItemListBean.DataBean?, var tag: Any?) {
            ...
            data class DataBean(var dataType: String?, var id: Int, var title: String?,
                                ...
                                var duration: Long?, var playUrl: String, var cover: open.moive.mvp.model.bean.HomeBean.IssueListBean.ItemListBean.DataBean.CoverBean?, var author: open.moive.mvp.model.bean.HomeBean.IssueListBean.ItemListBean.DataBean.AuthorBean?,
                                var releaseTime : Long?, var consumption: open.moive.mvp.model.bean.HomeBean.IssueListBean.ItemListBean.DataBean.ConsumptionBean?) {
