package open.moive.mvp.model.bean

/**
 * Created by lvruheng on 2017/7/7.
 */

data class HotBean(var count: Int, var total: Int, var nextPageUrl: Any?, var itemList: List<open.moive.mvp.model.bean.HotBean.ItemListBean>?) {

    data class ItemListBean (var type: String?, var data: open.moive.mvp.model.bean.HotBean.ItemListBean.DataBean?, var tag: Any?){

        data class DataBean(var dataType: String?, var id: Int, var title: String?,
                            var slogan: Any?, var description: String?, var provider: open.moive.mvp.model.bean.HotBean.ItemListBean.DataBean.ProviderBean?,
                            var category: String?, var author: Any?, var cover: open.moive.mvp.model.bean.HotBean.ItemListBean.DataBean.CoverBean?,
                            var playUrl: String?, var thumbPlayUrl: Any?, var duration: Long,
                            var releaseTime: Long, var library: String?,
                            var consumption: open.moive.mvp.model.bean.HotBean.ItemListBean.DataBean.ConsumptionBean?, var campaign: Any?, var waterMarks: Any?,
                            ...
                            var lastViewTime: Any?, var playInfo: List<open.moive.mvp.model.bean.HotBean.ItemListBean.DataBean.PlayInfoBean>?, var tags: List<open.moive.mvp.model.bean.HotBean.ItemListBean.DataBean.TagsBean>?,
            ...
            data class PlayInfoBean(var height: Int,var width: Int ,var name: String?,
                                    var type: String?,var url: String? ,var urlList: List<open.moive.mvp.model.bean.HotBean.ItemListBean.DataBean.PlayInfoBean.UrlListBean>?) {
