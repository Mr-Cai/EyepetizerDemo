...
import open.moive.mvp.contract.FindDetailContract
import open.moive.mvp.model.bean.HotBean
import open.moive.mvp.presenter.FindDetailPresenter
...
class FindDetailActivity : AppCompatActivity(), FindDetailContract.View, SwipeRefreshLayout.OnRefreshListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mAdapter = open.moive.adapter.RankAdapter(this, mList)
        recyclerView.adapter = mAdapter
        refreshLayout.setOnRefreshListener(this)
        mPresenter = open.moive.mvp.presenter.FindDetailPresenter(this, this)
