...
class DownloadAdapter(context: Context, list: ArrayList<VideoBean>) : RecyclerView.Adapter<DownloadAdapter.DownloadViewHolder>() {
    ...
    lateinit var mOnLongLisenter: open.moive.adapter.DownloadAdapter.OnLongClickListener
    var context: Context? = null
    var list: ArrayList<open.moive.mvp.model.bean.VideoBean>? = null
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): open.moive.adapter.DownloadAdapter.DownloadViewHolder {
        return open.moive.adapter.DownloadAdapter.DownloadViewHolder(inflater?.inflate(R.layout.item_download, parent, false), context!!)


    }

    override fun onBindViewHolder(holder: open.moive.adapter.DownloadAdapter.DownloadViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            var videoBean = open.moive.mvp.model.bean.VideoBean(photoUrl, title, desc, duration, playUrl, category, blurred, collect, share, reply, time)
    ...
    private fun getDownloadState(playUrl: String?, holder: open.moive.adapter.DownloadAdapter.DownloadViewHolder?) {
    ...
    fun setOnLongClickListener(onLongClickListener: open.moive.adapter.DownloadAdapter.OnLongClickListener) {
