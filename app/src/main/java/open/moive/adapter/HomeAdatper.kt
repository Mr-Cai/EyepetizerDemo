 ...
 */
class HomeAdatper(context: Context, list: MutableList<HomeBean.IssueListBean.ItemListBean>?) : RecyclerView.Adapter<open.moive.adapter.HomeAdatper.HomeViewHolder>() {


    var context: Context? = null
    var list: MutableList<open.moive.mvp.model.bean.HomeBean.IssueListBean.ItemListBean>? = null
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HomeAdatper.HomeViewHolder {
        return HomeAdatper.HomeViewHolder(inflater?.inflate(R.layout.item_home, parent, false), context!!)
    }

    override fun onBindViewHolder(holder: HomeAdatper.HomeViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            var videoBean = open.moive.mvp.model.bean.VideoBean(photo, title, desc, duration, playUrl, category, blurred, collect, share, reply, time)
