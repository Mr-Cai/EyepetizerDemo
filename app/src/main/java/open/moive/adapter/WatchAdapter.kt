 ...
 */
class WatchAdapter(context: Context, list: ArrayList<open.moive.mvp.model.bean.VideoBean>) : RecyclerView.Adapter<open.moive.adapter.WatchAdapter.WatchViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): open.moive.adapter.WatchAdapter.WatchViewHolder {
        return open.moive.adapter.WatchAdapter.WatchViewHolder(inflater?.inflate(R.layout.item_feed_result, parent, false), context!!)
    }

    override fun onBindViewHolder(holder: open.moive.adapter.WatchAdapter.WatchViewHolder, position: Int) {
