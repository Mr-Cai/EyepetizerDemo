 ...
 */
class RankAdapter(context: Context, list: ArrayList<open.moive.mvp.model.bean.HotBean.ItemListBean.DataBean>) : RecyclerView.Adapter<open.moive.adapter.RankAdapter.RankViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): open.moive.adapter.RankAdapter.RankViewHolder {
        return open.moive.adapter.RankAdapter.RankViewHolder(inflater?.inflate(R.layout.item_rank, parent, false), context!!)
    }

    override fun onBindViewHolder(holder: open.moive.adapter.RankAdapter.RankViewHolder, position: Int) {
