 ...
 */
class FeedAdapter(context: Context, list: ArrayList<open.moive.mvp.model.bean.HotBean.ItemListBean.DataBean>) : RecyclerView.Adapter<open.moive.adapter.FeedAdapter.FeedViewHolder>() {

    var context: Context? = null
    var list: ArrayList<open.moive.mvp.model.bean.HotBean.ItemListBean.DataBean>? = null
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): open.moive.adapter.FeedAdapter.FeedViewHolder {
        return open.moive.adapter.FeedAdapter.FeedViewHolder(inflater?.inflate(R.layout.item_feed_result, parent, false), context!!)
    }

    override fun onBindViewHolder(holder: open.moive.adapter.FeedAdapter.FeedViewHolder, position: Int) {
