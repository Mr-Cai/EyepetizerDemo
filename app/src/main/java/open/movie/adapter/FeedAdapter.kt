 ...
 */
class FeedAdapter(context: Context, list: ArrayList<open.movie.mvp.model.bean.HotBean.ItemListBean.DataBean>) : RecyclerView.Adapter<open.movie.adapter.FeedAdapter.FeedViewHolder>() {
